...
export class VertexArray {
  ...
  private _indexBuffer:IndexBuffer;
    ...
    private _mode = options.mode || 'TRIANGLES';
    private _counts = options.counts;
    private _buffers = options.buffers;
    private _color = !!options.buffers.color;
  constructor(options) {
  ...
  intersect(org, dir) {
    ...
    let this = this,
      indices = this._indexBuffer && this._indexBuffer.data,
